...
NS_LOG_COMPONENT_DEFINE ("ClassCEndDeviceExample");

void SendPacket(Ptr<NetworkServer> server, Ptr<Packet> pkt, LoraDeviceAddress endDevice) {
  server->Send(pkt, endDevice);	
}
